...
#im.show()
cv2.imwrite("results/finalinitial.jpg", cv2.cvtColor(np.uint8(initial*255), cv2.COLOR_RGB2BGR))
...
#im.show()
# cv2.imwrite("results/finalfinal.jpg", cv2.cvtColor(np.uint8(final*255), cv2.COLOR_RGB2BGR))
